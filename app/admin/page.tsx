      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-white shadow rounded-lg p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <Link href="/admin/properties/new" className="flex items-center p-4 border border-gray-200 rounded-lg hover:bg-gray-50">
            ...
            <Link href="/admin/users" className="flex items-center p-4 border border-gray-200 rounded-lg hover:bg-gray-50">
            ...
            <Link href="/admin/inquiries" className="flex items-center p-4 border border-gray-200 rounded-lg hover:bg-gray-50">
            ...
            <Link href="/admin/settings" className="flex items-center p-4 border border-gray-200 rounded-lg hover:bg-gray-50">
